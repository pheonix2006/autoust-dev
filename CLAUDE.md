...
asking to modify AutoStudy itself.

Use focused subagents for exploration, validation, and repetitive workflow checks
when that improves quality without bypassing the loading boundary above.
